...
| RQ-029 | Agentは担当チケットのみ更新できる | Must | TCND-040 | TC-007 | 一部 | 非担当の「ステータス変更」拒否は確認（Auto-04でUI側面を自動化済）。「更新」の定義（コメント等を含むか）の整理は引き続きC扱い。 |
...
- 一部カバー要件：RQ-002;RQ-005;RQ-006;RQ-008;RQ-027;RQ-029
