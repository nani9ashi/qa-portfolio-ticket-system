...
└── qa/                 # 🧪 QA統合成果物 (JSTQBプロセス準拠)
    ├── docs/           #    テスト計画・設計・報告書一式
    ├── automation/     #    PlaywrightによるE2E自動テスト
    ├── defects/        #    欠陥管理ログ・レポート
    └── testcases/      #    テストケース・要求トレーサビリティ
```

## 🔗 主要ドキュメントへのリンク
- 📦 **アプリケーション仕様書**: [app/README](./app/README.md)  
  - ロール権限、状態遷移、入力検証、意図的欠陥スイッチの解説
- 🧪 **QAテスト計画・自動化ガイド**: [qa/README](./qa/README.md)  
...
| **成果物** | JSTQB準拠ドキュメント一式 `qa/docs/`  | Playwrightコード `qa/automation/` |
...
- ▶ **詳細**: `qa/docs/`および [テストケース](../testcases/testcases.csv)
